...
public class PraktikumMandiri {
    public static void main(String[] args) {
        ...
        System.out.println("a. Hasil keliling lingkaran dengan diameter " + diameter + " adalah = " + kLingkaran);

        // SOAL NO.2 (B)
        int alas = 6;
        int tinggi = 8;
        float lSegitiga = 0.5f * alas * tinggi; 
        System.out.println("b. Hasil luas segitiga siku-siku dengan alas " + alas + " dan tinggi " + tinggi + " adalah = " + lSegitiga);
        ...
        System.out.println("c. Hasil volume tabung dengan diameter " + diameter + " dan tinggi " + tinggi + " adalah = " + vTabung);
    }
}
